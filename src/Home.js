                    ...
                    <div className="row">
                        <div className="col-10 mx-auto">
                            ...
                            <div className="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1">
                                <h1>Hello, I'm a GOLD II TFT Player For {""}<strong className="brand-name">Tier1 Gaming Lounge</strong></h1>
                                <h3 className="my-3">I have achieve the impossible, getting 3-star Sett & Kayn</h3>
                                <div className="mt-3">
